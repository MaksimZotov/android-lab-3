...
import com.maksimzotov.androidlab3.openAbout
    ...
    private fun testNav(
        ...
        for (i in 1..buttonsToFragmentsToBackStackSize.size) {
            ...
            list.forEach { item ->
                ...
                // Проверка поворота экрана отсутствует, так как сейчас тестируются
                // только Activities, из-за чего recreate (или поворот экрана, если бы мы
                // делали его) выполняются только на стартовой Activity
                //
                // scenario.recreate()
